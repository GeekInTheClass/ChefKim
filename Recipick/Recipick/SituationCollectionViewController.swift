//
//  SituationCollectionViewController.swift
//  Recipick
//
...
typealias Situation = (thumbnail:String, name:String)

class SituationCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        situations += [Situation(thumbnail:"icon_situ_party", name:"집에서 준비하는 파티음식"), Situation(thumbnail:"icon_situ_dinner", name:"근사한 저녁식사"), Situation(thumbnail:"icon_situ_diet", name:"다이어트 중이에요"), Situation(thumbnail:"icon_situ_summer", name:"더운 여름 이겨내기"), Situation(thumbnail:"icon_situ_breakfast", name:"빠르고 든든한 아침식사"), Situation(thumbnail:"icon_situ_sick", name:"몸이 좋지 않을 때")]
    }
