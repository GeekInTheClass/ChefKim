...
let Beefbureau = Recipe(id: 5348,
                        ...
                        recipe: ["재료",
                                 "무 200g, 소고기 130g, 콩나물 180~200g, 대파1, 청량고추2, 다시마육수1.2L, 액젓1큰술, 소금, 후추, 식용유",
                                 "고기양념 : 고춧가루 3큰술, 마늘 1.5큰술, 맛술 1큰술, 국간장 2큰술, 후추 톡톡", "무는 먹기 좋은 크기로 나박나박 썰고 대파와 청량고추는 썰어주세요",
...
let Fishpaste = Recipe(id: 5348,
                       ...
                       category: [Recipe.Category.Korean],
                       recipe: ["재료",
                                "어묵 230g, 무 180g, 대파 1/2, 멸치육수 1.2L 이상, 청량고추",
                                "고기양념 : 고춧가루 3큰술, 마늘 1.5큰술, 맛술 1큰술, 국간장 2큰술, 후추 톡톡",
                                "무는 먹기 좋은 크기로 나박나박 썰고 대파와 청량고추는 썰어주세요",
...
//야채피클
let PickledCucumber = Recipe(id: 5348,
                             name: "야채피클",
                             ...
                             recipe: ["재료",
                                      ...
                                      "만들기에 앞서 유리병을 열탕소독해 물기를 싸악 말려 준비합니다", "오이, 당근, 파프리카는 깨끗하게 세척 후 가능하면 물기를 최대한 털어내고 먹기 좋은 크기로 썰어줍니다",
...
//김치볶음밥
let KimchiFriedRice = Recipe(id: 5348,
                             name: "김치볶음밥",
...
//바지락 순두부찌개
let ClamSoftTofuStew = Recipe(id: 5348,
                             name: "바지락 순두부찌개",
                             ...
                             category: [Recipe.Category.Korean],
                             recipe: ["재료",
                                      "순두부 1팩, 바지락 크게 한줌, 물(육수)300ml, 대파 1/2, 청양고추 1~2, 양파(소)1/3, 다진마늘 1.5큰술, 식용우, 고춧가루 2큰술, 국간장 0.5큰술, 액젓 1큰술, 소금, 후추",
                                      "양파는 가늘게 채 썰고 대파는 어슷하게 썰어줍니다",
                                      "청양고추는 잘게 송송 썰어줍니다",
...
//제육볶음
let FriedSpicyPork = Recipe(id: 5348,
                            name: "재육볶음",
                            ...
                            category: [Recipe.Category.Korean],
                            recipe: ["재료",
                                     "돼지앞다리살 600g, 양파(중소) 1, 대파 1/2, 청양고추 1, 홍고추 1, 고춧가루 1큰술, 올리고당 1큰술, 참기름 0.5큰술, 식용유",
                                     "밑간 : 매실액 2큰술, 간장 3큰술, 다진마늘 1큰술, 후추 톡톡",
                                     "양념장 : 고춧가루 3큰술, 고추장 2큰술, 간장 1큰술, 맛술 1큰술, 설탕 1큰술, 다진마늘 1큰술, 생감가루 조금, 후추 톡톡",
...
//가지볶음
let FriedEggPlant = Recipe(id: 5348,
                           name: "가지볶음",
                           ingrediant: [Recipe.Ingrediant.Vege],
                           time: [Recipe.Time.H1],
                           ...
                           category: [Recipe.Category.Korean],
                           recipe: ["재료",
                                    "가지 2, 양파(소) 1, 청양고추 1, 홍고추 1, 대파 1/2, 식용유, 고추기름, 두반장 2.5큰술, 굴소스 1큰술, 설탕 0.3 ~ 0.5큰술, 후추, 소금",
...
//봉골레파스타
let VongolePasta = Recipe(id: 5348,
                          name: "봉골레파스타",
                          ingrediant: [Recipe.Ingrediant.Clam],
                          time: [Recipe.Time.H1],
                          situation: [Recipe.Situation.Dinner,Recipe.Situation.Home,Recipe.Situation.Party],
                          category: [Recipe.Category.Western],
                          recipe: ["재료", "바지락 200g 1팩, 파스타 170g, 올리브오일, 다진마늘 3큰술, 건고추 1, 맛술 2큰술, 후추, 소금, 월계수잎 1 ~ 2장", "해감시킨 바지락은 바락바락 주물러 여러 번 헹궈 물기를 털어 준비합니다",
...
//소고기미역국
let BeefSeaweedSoup = Recipe(id: 5348,
                             name: "소고기미역국",
                             ingrediant: [Recipe.Ingrediant.Beef],
                             time: [Recipe.Time.M30],
                             situation: [Recipe.Situation.Breakfast,Recipe.Situation.Home, Recipe.Situation.Dinner, Recipe.Situation.Snack, Recipe.Situation.Diet],
                             category: [Recipe.Category.Korean],
                             recipe: ["재료",
                                      "건미역 15g, 소고기 150g, 육수(물) 1.1L 이상, 참기름 1큰술, 다진마늘 1큰술, 국간장 1큰술, 멸치액젓 1클술, 참치액 1큰술, 소금", "밑간 : 국간장 1큰술, 후추 톡톡", "건미역에 물을 넉넉하게 부어 15 ~ 30분 정도 충분히 불려줍니다",
